...
async def yt_search(joker):
    try:
        joker = urllib.parse.quote(joker)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={joker}"
        )
...
"""
async def yt_data(joker):
    params = {"format": "json", "url": joker}
