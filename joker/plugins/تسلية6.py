...
@l313l.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular joker",
    },
)
...
@l313l.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular joker",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@l313l.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna joker is One of the Popular joker",
    },
)
async def nekobot(cat):
...
@l313l.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; joker is One of the Popular joker",
    },
)
async def nekobot(cat):
